 ...
 * @tree: This points to the root node of the tree to measure the height.
 ...
 * @func: This points to a function to call for each node.
...
/**
 * binary_tree_levelorder - This goes through a binary tree in level-order traversal
 * @tree: This points to the root node of the tree to traverse
 * @func: This points to a function to call for each node.
 */
